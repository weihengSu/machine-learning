...
for testC = [0.01 0.03 0.1 0.3 1, 3, 10 30]
    for testSigma = [0.01 0.03 0.1 0.3 1, 3, 10 30]
        ...
        identityMatrix(error,:) = [testC, testSigma, prediction_error];     
    end
end

sorted_results = sortrows(identityMatrix, 3); % sort matrix by column #3, the error, ascending
